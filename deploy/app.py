...
model = CNN()
model.load_state_dict(torch.load('/Users/shaileshsaravanan/Documents/VS Code/handwritten-digit-recognition/deploy/model.pt', map_location=torch.device('cpu')))
model.eval()
